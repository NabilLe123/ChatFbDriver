...
import com.lelab.chatfbdriver.model.Chat;
import com.lelab.chatfbdriver.model.ChatAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvWelcome.setText("Welcome Driver: " + driver);
        ...
        ivSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(etMsg.getText().toString().trim())) {
                    sendMessage(driver, "nab", etMsg.getText().toString().trim());
        ...
        final ChatAdapter chatAdapter = new ChatAdapter(this, chats, driver);
