package com.lelab.chatfbdriver.model;
...
import com.lelab.chatfbdriver.R;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        if (getItemViewType(position) == TYPE_ME) {
            ((MeViewHolder) viewHolder).setMeDetails(position, chats.get(position));
        } else {
            ((FriendViewHolder) viewHolder).setFriendDetails(position, chats.get(position));
        }
    }
    ...
    static class MeViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setMeDetails(int position, Chat chat) {
            Log.d("rxjava", position + " send: " + chat.getSender() + " receive: " + chat.getReceiver());
    ...
    static class FriendViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setFriendDetails(int position, Chat chat) {
            Log.d("rxjava", position + " send: " + chat.getSender() + " receive: " + chat.getReceiver());
            tvName.setText(chat.getSender());
            tvMessage.setText(chat.getMessage());
        }
